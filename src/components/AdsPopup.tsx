...
export default function AdsPopup() {
    ...
    return (
        <div className="fixed right-4 bottom-4 z-50 w-[326px] border shadow-lg rounded-md">
            <div className="relative bg-red-600 text-white text-center py-2 font-bold">
                cellphoneS
                <button onClick={() => setVisible(false)} className="absolute top-1 right-2 text-white hover:text-gray-200">
                    ✕
                </button>
            </div>
