const Footer = () => {
    return (
        <footer className="bg-[#c31e40] text-white mt-10 pt-10 pb-8 text-base ">
            <div className="mx-auto max-w-[1300px] px-4 grid grid-cols-1 md:grid-cols-[25%_40%_35%] gap-6 items-start container">

                <div className="flex flex-col items-center text-center">
                    <img
                        src="https://cdn.giaoducthoidai.vn/assets/web/styles/img/logo.svg"
                        alt="Logo"
                        className="w-48 mb-3 brightness-0 invert"
                    />
                ...
                <div className="space-y-3">
                    ...
                    <p className="text-lg">Cơ quan chủ quản: <b>Bộ Giáo dục và Đào tạo</b></p>
                    <p className="text-lg">Số giấy phép 479/GP-BTTTT, cấp ngày 29/10/2020, ISSN 1859-2945.</p>
                    <p className="text-lg">Tổng Biên tập: Triệu Ngọc Lâm</p>
                    <p className="text-lg">Phó Tổng Biên tập: Dương Thanh Hương - Nguyễn Đức Tuân</p>
                    <p className="text-lg">
                ...
                <div className="space-y-8">
                    <div>
                        <h3 className="text-xl font-bold mb-1 uppercase">Trụ sở chính</h3>
